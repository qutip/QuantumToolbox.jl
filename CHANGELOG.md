...
- Merge `ProductDimensions` and `GeneralProductDimensions` into `ProductDimensions`. The dimensions are now assumed to be always general. This simplifies the sructure and usage of dimensions. ([#649])
