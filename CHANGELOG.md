...
- [lib] Bump `QuantumToolboxCore` version to `v0.2.0`. ([#759])
...
[v0.47.4]: https://github.com/qutip/QuantumToolbox.jl/releases/tag/v0.47.4
...
[#759]: https://github.com/qutip/QuantumToolbox.jl/issues/759
