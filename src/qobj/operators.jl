...
rand_unitary(dimensions::Union{ProductDimensions,AbstractVector{Int},Tuple}, distribution::Union{Symbol,Val} = Val(:haar)) =
...
rand_unitary(dimensions::Union{ProductDimensions,AbstractVector{Int},Tuple}, ::Val{T}) where {T} =
