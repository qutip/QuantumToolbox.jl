...
function smesolve(
    ...
    expvals_all = _stack_traj_expvals(ens_prob.kwargs.has_e_ops, sol, SaveFuncMESolve) # Stack on dimension 2 to align with QuTiP
    ...
    m_expvals = _stack_traj_m_expvals(ens_prob.kwargs.store_measurement, sol, SaveFuncSMESolve)
